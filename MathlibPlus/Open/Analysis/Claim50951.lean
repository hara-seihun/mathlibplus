...
namespace MathlibPlus.Open.Analysis.Claim50951

/-- The canonical rank-four shell determinant and its scalar reproduction
identity, with the ordered analytic reserve carrier retained. -/
def canonicalShellScalarReproduction
...
end MathlibPlus.Open.Analysis.Claim50951
