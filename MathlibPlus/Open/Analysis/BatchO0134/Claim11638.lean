...
namespace MathlibPlus.Open.Analysis.BatchO0134.Claim11638
...
/-- The Laguerre expression for the gamma-windowed heat derivative kernel. -/
def laguerreFormulaForK : Prop :=
  ∀ (m : ℕ) (t u : ℝ),
    0 < t →
      heatKernel m t u =
...
end MathlibPlus.Open.Analysis.BatchO0134.Claim11638
