...
namespace MathlibPlus.Open.ResearchFormalization.BatchR2625Claim42891
...
def totalGcdShellContribution
    (B₂ : Polarization 2) (B₃ : Polarization 3) (B₄ : Polarization 4)
    (d : ℕ) : ℝ :=
  gcdShellContribution B₂ d + gcdShellContribution B₃ d +
    gcdShellContribution B₄ d
...
def exactCommonGcdShellContributions_claim42891 : Prop :=
  ∃ (B₂ : Polarization 2) (B₃ : Polarization 3) (B₄ : Polarization 4),
...
end MathlibPlus.Open.ResearchFormalization.BatchR2625Claim42891
