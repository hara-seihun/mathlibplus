...
namespace MathlibPlus.Open.ResearchFormalization.R1641
...
/-- Claim 39866: the minimum common two-point subgroup-coset branch has
    conjugate regular copies in the full automorphism group of the exact
    ordinary undirected Cayley graph. -/
def claim39866 : Prop :=
  ∀ (S : Set G) (R T : Subgroup (Equiv.Perm G))
    (D : AddSubgroup G),
    Nat.card D = 2 →
...
end MathlibPlus.Open.ResearchFormalization.R1641
