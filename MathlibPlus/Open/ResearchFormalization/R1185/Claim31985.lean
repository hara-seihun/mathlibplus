...
namespace MathlibPlus.Open.ResearchFormalization.R1185.Claim31985
...
def exceptionalQ12SwitchAndPrimeCoverGroup_claim31985 : Prop :=
  ∀ p : ℕ, Nat.Prime p → 3 < p →
...
end MathlibPlus.Open.ResearchFormalization.R1185.Claim31985
