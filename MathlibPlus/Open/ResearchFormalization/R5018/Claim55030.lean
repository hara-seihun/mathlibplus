...
namespace MathlibPlus.Open.ResearchFormalization.R5018.Claim55030
...
def claim55030
  ...
  ∀ E0 : P, L1.comp E0.1 = S.comp L0 →
    (∀ E1 : P, L1.comp E1.1 = S.comp L0 →
      allLiftsResponseClass P L0 L1 A0 A1 E1.1 =
        allLiftsResponseClass P L0 L1 A0 A1 E0.1) ∧
    (allLiftsResponseClass P L0 L1 A0 A1 E0.1 = 0 ↔
      ∃ E : P, ∃ Ψ : Hom W0 Z,
        L1.comp E.1 = S.comp L0 ∧
        A1.comp E.1 = A0 + Ψ.comp L0)

end MathlibPlus.Open.ResearchFormalization.R5018.Claim55030
