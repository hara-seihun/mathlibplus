...
namespace MathlibPlus.Open.ResearchFormalization.R0761Claim24550
...
def claim24550 : Prop :=
  ∀ p : ℕ, Nat.Prime p → 5 ≤ p →
    ∀ (φ : LiftDih p ≃ LiftDih p) (P : AffineParameters p),
      ...
      exactlyOne (P.u = 1 ∧ P.M vAnchor = -vAnchor)
        (P.u = -1 ∧ P.M vAnchor = vAnchor)


end

end MathlibPlus.Open.ResearchFormalization.R0761Claim24550
