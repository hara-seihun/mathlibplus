...
namespace MathlibPlus.Open.ResearchFormalization.R1393Claim38546
...
/-- Claim 38546: point-stabilizer suborbits are affine ideals. -/
def pointStabilizerSuborbitsAreAffineIdeals : Prop :=
  ∀ (p : ℕ) (hp : Nat.Prime p),
    ...
    ∀ (A : Type*) [NonUnitalNonAssocRing A]
      ...
      zeroStabilizer G = gammaSet (A := A) ∧
        ∀ x : A, pointStabilizerOrbit G x = affineIdealCoset x

end MathlibPlus.Open.ResearchFormalization.R1393Claim38546
