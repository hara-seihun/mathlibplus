...
/-- Claim 39333: the exact characteristic-two singleton cancellation formula. -/
def claim39333 : Prop :=
  ∀ A : Arm → ℕ,
    KPolynomial A =
      1 + Polynomial.X ^ 2 * singletonPolynomial A +
        eTwo A + eThree A + Polynomial.X ^ totalExponent A
