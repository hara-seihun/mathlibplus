...
maximal optimal posterior-variance areas on the positive integer weight grids
of total weight `4`, `5`, `6`, `7`, and `8` are respectively `41/32`,
`133/100`, `197/144`, `277/196`, and `373/256`.
...
-/
def positiveWeightGridDepthTwoFourCubeAreaMaxima : Prop :=
  let Ω := Fin 4 → Bool
  ...
  Attains 4 (41 / 32) ∧ Attains 5 (133 / 100) ∧
    Attains 6 (197 / 144) ∧ Attains 7 (277 / 196) ∧
    Attains 8 (373 / 256)
