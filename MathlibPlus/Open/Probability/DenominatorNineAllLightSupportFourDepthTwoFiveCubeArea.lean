...
root-inclusive posterior-variance areas of denominator-nine depth-at-most-two
laws with four pairwise-distinct semantic tables are `229 / 162`, `112 / 81`,
`101 / 72`, and `112 / 81` in the respective multiplicity strata `4+3+1+1`,
`4+2+2+1`, `3+3+2+1`, and `3+2+2+2`.
-/
def denominatorNineAllLightSupportFourDepthTwoFiveCubeAreaMaxima : Prop :=
  ...
  let target : Target := fun trees weights x =>
    (∑ i : Fin 4, weights i * evalTree (trees i) x) / 9
  ...
  Attains ![4, 3, 1, 1] (229 / 162) ∧
    Attains ![4, 2, 2, 1] (112 / 81) ∧
    Attains ![3, 3, 2, 1] (101 / 72) ∧
    Attains ![3, 2, 2, 2] (112 / 81)
